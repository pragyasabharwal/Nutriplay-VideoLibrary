      ...
      <div className="nav-toggle-display">
        <div className={state.displayNav ? 'nav-disable' : 'nav'}>
          <i
            ...
            onClick={() => dispatch({ type: 'TOGGLE_NAV' })}
          ></i>
          <Link to="/" onClick={() => dispatch({ type: 'TOGGLE_NAV' })}>
            <li className="home">
              <i class="fas fa-home"></i>Home
            </li>
          </Link>
          <Link to="/library" onClick={() => dispatch({ type: 'TOGGLE_NAV' })}>
            <li>
              <i class="fab fa-youtube"></i>
              <span>Library</span>
            </li>
          </Link>
          <Link to="/history" onClick={() => dispatch({ type: 'TOGGLE_NAV' })}>
            <li>
          ...
          <Link to="/liked" onClick={() => dispatch({ type: 'TOGGLE_NAV' })}>
            <li>
          ...
          <li>
            <Link to="/saved" onClick={() => dispatch({ type: 'TOGGLE_NAV' })}>
